...
function update() {
    ...
    //  downDuration does not schedule key pressing, it's merely indicative of key states. In this case,
    //  the downDuration function tells us that between this current time and 250 milliseconds ago, this key
