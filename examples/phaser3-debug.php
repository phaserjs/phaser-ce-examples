        ...
        <?php
            if ($target == 'div')
            {
                if ($dist === 'php' && in_array($_SERVER['SERVER_NAME'], $config_hosts))
                {
                    ...
                    require($path . '/build/phaser3-config.php');
                }
                else
                {
            ...
            <?php
                ...
                ?>
                    <div style="display: inline-block; margin: 16px">
                        ...
                        <a class="example selected" href="phaser3-debug.php?s=<?php echo $current ?>"><?php echo $current ?></a>
                    </div>
                ...
                <?php
                    ...
                    {
                        $fcheck = $current . '/' . $item;
                        $url = "phaser3-debug.php?s=$current&amp;f=$current/$item";
                ...
                <div style="display: inline-block; margin: 16px">
                    ...
                    <a class="example" href="phaser3-debug.php?s=<?php echo $key ?>"><?php echo $key ?></a>
                </div>
                <?php
                }
                ?>
